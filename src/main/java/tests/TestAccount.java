...
public class TestAccount extends BaseTest {
	...
	@Test
	public void testremoveAccountWithMovement() {
		menuPage.triggerMenuListAccount();
		accountPage.removeAccount("Conta 1A");
		listAccountsPage.verifyAccountRegisterErrorMsg("Conta em uso na movimentações");
	}
